...
pprint(
    reports_service.delete_report(
        report_id='33bcbb15-514b-471a-be7e-123fbdd9d260'
    )
)
...
with open(file='exports/my_report_export_2.pbix', mode='wb+') as power_bi_file:
...
my_report_content = reports_service.export_to_file(
    report_id='7ebf3bcb-3d3f-4236-9bf1-bba71b1310d3',
