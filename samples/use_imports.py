"""Demonstrates how to use the `Imports` service."""
...
pprint(imports_service.create_temporary_upload_location())

# Get all the Imports from my workspace.
pprint(imports_service.get_imports())

# Query a specific Import from my workspace.
pprint(imports_service.get_import(import_id="e40f7c73-84d1-4cf5-a696-5850a5ec8ad3"))
